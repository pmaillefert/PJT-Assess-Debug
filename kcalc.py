...
def calculUtilityMultiplicative(myK, myU):
    if len(myK) - 1 == 2:
        ...
        return {'Ulatex':utilite6(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], myK[6]['value'], convert_to_text_latex(myU[0], myU[0]['name']), convert_to_text_latex(myU[1], myU[1]['name']), convert_to_text_latex(myU[2], myU[2]['name']), convert_to_text_latex(myU[3], myU[3]['name']), convert_to_text_latex(myU[4], myU[4]['name']), convert_to_text_latex(myU[5], myU[5]['name'])),'Uexcel':utilite6(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], myK[6]['value'], convert_to_text_excel(myU[0], myU[0]['name']), convert_to_text_excel(myU[1], myU[1]['name']), convert_to_text_excel(myU[2], myU[2]['name']), convert_to_text_excel(myU[3], myU[3]['name']), convert_to_text_excel(myU[4], myU[4]['name']), convert_to_text_excel(myU[4], myU[4]['name'])), 'U': utilite6(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], myK[6]['value'], convert_to_text(myU[0], myU[0]['name']), convert_to_text(myU[1], myU[1]['name']), convert_to_text(myU[2], myU[2]['name']), convert_to_text(myU[3], myU[3]['name']), convert_to_text(myU[4], myU[4]['name']), convert_to_text(myU[4], myU[4]['name'])), 'k': myK, 'utilities': myU}
    U = 1
